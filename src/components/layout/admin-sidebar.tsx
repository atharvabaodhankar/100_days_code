...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 border-r border-zinc-800 bg-zinc-950/40 p-4 flex flex-col justify-between shrink-0 hidden md:flex">
      ...
      {/* Admin Quick Meta */}
      <div className="rounded-lg border border-zinc-800/80 bg-zinc-900/40 p-3 text-[11px] text-zinc-400 space-y-1">
        <div className="flex justify-between">
          <span>AI Primary:</span>
          <span className="text-zinc-200 font-mono">Gemini 1.5</span>
        </div>
        <div className="flex justify-between">
          <span>AI Fallback:</span>
          <span className="text-zinc-200 font-mono">Groq Llama-3</span>
        </div>
        <div className="flex justify-between">
          <span>Database:</span>
          <span className="text-zinc-200 font-mono">Firestore</span>
        </div>
      </div>
    </aside>
  );
