...
export function LoadingState({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center py-16 px-4 text-center rounded-lg border border-zinc-800/60 bg-zinc-900/30",
        className
      )}
    >
...
export function SkeletonCard() {
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-5 animate-pulse space-y-4">
