...
import { ChevronLeft, ChevronRight, Calendar, ArrowLeft, Layers } from "lucide-react";
    ...
    <div className="space-y-8 py-2">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6 space-y-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <span className="font-mono text-xs font-semibold text-zinc-300 bg-zinc-800 px-2.5 py-0.5 rounded border border-zinc-700/50">
